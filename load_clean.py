...
RAW = Path(r"C:\Users\vishv\Downloads\python_learning.1st project\__MACOSX\agriculture_dashboard\data\ICRISAT-District Level Data - ICRISAT-District Level Data.csv")
